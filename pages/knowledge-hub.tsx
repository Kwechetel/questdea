...
import shopImage from "../src/assets/shop.png";
                  ...
                  <CardMedia
                    ...
                    image={
                      typeof course.image === "string"
                        ? course.image
                        : (course.image as any)?.src || String(course.image)
                    }
                    alt={course.title}
                  />
                  <CardContent>
                  ...
                  <CardMedia
                    ...
                    image={
                      typeof article.image === "string"
                        ? article.image
                        : (article.image as any)?.src || String(article.image)
                    }
                    alt={article.title}
                  />
                  <CardContent>
                  ...
                  <CardMedia
                    ...
                    image={
                      typeof podcast.image === "string"
                        ? podcast.image
                        : (podcast.image as any)?.src || String(podcast.image)
                    }
                    alt={podcast.title}
                  />
                  <CardContent>
